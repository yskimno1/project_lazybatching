...
/usr/local/cuda-10.1/bin/nvcc -o $HOME/Project/anybatch $HOME/Project/cudnn.cu $HOME/Project/build/layer.o $HOME/Project/build/model.o -lcudnn -lcublas -lz -std=c++11
